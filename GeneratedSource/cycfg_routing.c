...
void init_cycfg_routing(void)
{
	...
	Cy_TrigMux_Connect(TRIG14_IN_PASS_TR_CTDAC_EMPTY, TRIG14_OUT_TR_GROUP0_INPUT44, false, TRIGGER_TYPE_LEVEL);
	CTBM0->CTD_SW = CTBM_CTD_SW_CTDH_CA0_Msk |
		CTBM_CTD_SW_CTDO_COS_Msk;
	CTBM0->OA0_SW = CTBM_OA0_SW_OA0M_A81_Msk |
		CTBM_OA0_SW_OA0O_D81_Msk;
